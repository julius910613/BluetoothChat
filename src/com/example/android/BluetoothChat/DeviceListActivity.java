...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button scanButton = (Button) findViewById(R.id.bluetooth_button_scan);
        ...
        ListView pairedListView = (ListView) findViewById(R.id.bluetooth_paired_devices);
        pairedListView.setAdapter(mPairedDevicesArrayAdapter);
        pairedListView.setOnItemClickListener(mDeviceClickListener);

        // Find and set up the ListView for newly discovered devices
        ListView newDevicesListView = (ListView) findViewById(R.id.bluetooth_new_devices);
